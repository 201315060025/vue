<template>
  <div class="picview">
    <a @click="seePic()" style="width:100px ;height:100px;">
      <img :src="src" style="object-fit:scale-down" />
    </a>
    <el-dialog
      class="picture"
      ...
      @opened="scalePic"
    >
      <i @click="rotePic" class="revolve" style="position: absolute"></i>
